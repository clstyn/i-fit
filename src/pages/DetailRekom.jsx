...
const DetailRekom = () => {
  ...
  return (
    <div className="font-poppins text-c-birdong">
      <Navbar />
      <div className="flex w-5/6 mx-auto mt-48 gap-12">
        <div className="w-1/2">
          ...
          <p className="mt-8 text-xl text-right">{item.desc}</p>
        ...
        <div className="w-1/2 h-[335px] rounded-lg bg-gray-500"></div>
      </div>
      ...
      <div id="reference" className="bg-detail-rekom bg-cover py-24 ">
        <div className="flex flex-col w-5/6 mx-auto items-center justify-center">
          <h1 className="mt-24 mb-12 font-kaushan text-6xl">Referensi</h1>
